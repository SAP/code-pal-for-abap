...
CLASS ltc_num_public_attributes DEFINITION FOR TESTING
  RISK LEVEL HARMLESS
  DURATION SHORT.
...
CLASS y_check_num_public_attributes DEFINITION LOCAL FRIENDS ltc_num_public_attributes.

CLASS ltc_num_public_attributes IMPLEMENTATION.
  METHOD setup.
