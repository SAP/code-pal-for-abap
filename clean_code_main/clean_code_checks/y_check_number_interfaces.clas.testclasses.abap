...
CLASS ltc_number_interfaces DEFINITION FOR TESTING
  RISK LEVEL HARMLESS
  DURATION SHORT.

  PRIVATE SECTION.
    DATA: cut                     TYPE REF TO y_check_number_interfaces,
...
CLASS y_check_number_interfaces DEFINITION LOCAL FRIENDS ltc_number_interfaces.

CLASS ltc_number_interfaces IMPLEMENTATION.
  METHOD setup.
    cut = NEW y_check_number_interfaces( ).
