...
CLASS ltc_declaration_in_if DEFINITION FOR TESTING
  RISK LEVEL HARMLESS
  DURATION SHORT.
...
CLASS y_check_declaration_in_if DEFINITION LOCAL FRIENDS ltc_declaration_in_if.

CLASS ltc_declaration_in_if IMPLEMENTATION.
  METHOD setup.
