...
CLASS ltd_ref_scan_manager IMPLEMENTATION.
  ...
  METHOD set_data_for_ok.
    ...
    tokens = VALUE #( ( str = 'EVENTS'       type = 'I' row = 1 )
                      ( str = 'EVENTS'       type = 'I' row = 1 )     "(event name) check should differ between keyword and name
                      ( str = 'EVENTS'       type = 'I' row = 2 )
                      ( str = 'E2'           type = 'I' row = 2 ) ).
  ENDMETHOD.
  ...
  METHOD set_pseudo_comment_ok.
    ...
    tokens = VALUE #( ( str = 'CLASS'              type = 'I' row = 1 )
                      ...
                      ( str = '"#EC NUMBER_EVENTS' type = 'C' row = 1 )
                      ( str = 'EVENTS'             type = 'I' row = 2 )
                      ( str = 'E1'                 type = 'I' row = 2 )
                      ( str = 'EVENTS'             type = 'I' row = 3 )
                      ( str = 'E2'                 type = 'I' row = 3 )
                      ( str = 'CLASS-EVENTS'       type = 'I' row = 4 )
                      ( str = 'E3'                 type = 'I' row = 4 )
...
CLASS ltc_number_methods DEFINITION FOR TESTING
  ...
  PRIVATE SECTION.
    DATA: cut                     TYPE REF TO y_check_number_events,
...
CLASS y_check_number_events DEFINITION LOCAL FRIENDS ltc_number_methods.

CLASS ltc_number_methods IMPLEMENTATION.
  METHOD setup.
    cut = NEW y_check_number_events( ).
