...
CLASS ltc_number_attributes DEFINITION FOR TESTING
  RISK LEVEL HARMLESS
  DURATION SHORT.
...
CLASS y_check_number_attributes DEFINITION LOCAL FRIENDS ltc_number_attributes.

CLASS ltc_number_attributes IMPLEMENTATION.
  METHOD setup.
