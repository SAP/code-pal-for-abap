INTERFACE y_if_clean_code_manager PUBLIC.
  ...
  METHODS calculate_obj_creation_date IMPORTING object_name   TYPE sobj_name
                                                object_type   TYPE trobjtype
                                      RETURNING  VALUE(result) TYPE creationdt.

  METHODS is_profile_in_use RETURNING VALUE(result) TYPE abap_bool.
