...
Code pal for ABAP is an free open source project and licensed under the Apache License, Version 2.0 - see [LICENSE](LICENSE)

**Please be aware that SAP does not provides support for any open source projects.**
